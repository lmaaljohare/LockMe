...
using Java.Lang;
using LockMe.DependencyServices.Droid;
using LockMe.Droid;
using LockMe.Models;
using LockMe.Service;

[assembly: Xamarin.Forms.Dependency(typeof(LocalNotificationService))]

namespace LockMe.DependencyServices.Droid
{
    ...
    public class LocalNotificationService : ILocalNotificationService
    {
        ...
        public void LocalNotification(string title, string body, int id, DateTime notifyTime)
        {
           ...
           /* else
            {
                localNotification.IconId = Xamarin.Essentials.Resource.Drawable.notificationgrey;
            }*/
