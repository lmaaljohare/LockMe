...
namespace LockMe.Droid
{
    ...
    public class AndroidService : IAndroidService
    {
        public List<HomePageModel> GetIntalledApps()
        {
            ...
            {
                inApps.Add(new HomePageModel(apps[i].LoadLabel(Android.App.Application.Context.PackageManager), apps[i].PackageName, apps[i].LoadIcon(Android.App.Application.Context.PackageManager)));
            }
